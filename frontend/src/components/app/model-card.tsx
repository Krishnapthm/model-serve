                ...
                <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1 space-y-1.5">
                        <div className="flex items-center gap-2">
                            <h3 className="font-medium text-sm truncate" title={model.display_name}>
                                {model.display_name}
                            </h3>
                            <StatusBadge status={model.status} />
                        </div>
                        <p className="text-xs text-muted-foreground font-mono truncate" title={model.model_id}>
                            {model.model_id}
                        </p>
                    ...
                    <Button
                        ...
                        className="shrink-0"
                    >
                        {copied ? <IconCheck size={15} className="mr-1" /> : <IconCopy size={15} className="mr-1" />}
